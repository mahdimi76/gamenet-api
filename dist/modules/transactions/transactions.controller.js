...
let TransactionsController = class TransactionsController {
    ...
    getStats(gameNetId, startDate, endDate) {
        return this.transactionsService.getStats(gameNetId, new Date(startDate), new Date(endDate));
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], TransactionsController.prototype, "findByCustomer", null);
__decorate([
    (0, common_2.Auth)(),
