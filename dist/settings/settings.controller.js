...
let SettingsController = class SettingsController {
    ...
    findByGameNet(gameNetId) {
        return this.settingsService.findByGameNet(gameNetId);
    }
    upsert(gameNetId, updateSettingsDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [settings_dto_1.CreateSettingsDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SettingsController.prototype, "findByGameNet", null);
__decorate([
    (0, common_2.Auth)(),
    (0, common_1.Put)(),
    __param(0, (0, common_1.Query)('gameNetId')),
